...
public01.x: public01.o string-graph.o 
	$(CC) public01.o string-graph.o compare-vertex-lists.o -o public01.x

public02.x: public02.o string-graph.o 
	$(CC) public02.o string-graph.o -o public02.x

public03.x: public03.o string-graph.o 
	$(CC) public03.o string-graph.o compare-vertex-lists.o -o public03.x
...
public06.x: public06.o string-graph.o 
	$(CC) public06.o string-graph.o memory-functions.o -o public06.x
...
public08.x: public08.o string-graph.o 
	$(CC) public08.o string-graph.o memory-functions.o -o public08.x
...
# Object Operations
#
string-graph.o: string-graph.c string-graph.h
...
public04.o: public04.c string-graph.h 
...
clean: 
	...
	public06.o public07.o public08.o public09.o public10.o string-graph.o 